...
export const metadata = {
  title: "About Us - Luminous Dental",
  description: "Learn more about Luminous Dental and our commitment to quality care.",
};

const About = () => {
  // Define header data as static props for server-side rendering
  const headerData = {
    title: "About Us",
    breadcrumbs: [
